...
(function run() {
    ...
    let militaryAirport = new Airport(airport.getListOfPlanesOfAppropriateType(MilitaryPlane));
    let passengerAirport = new Airport(airport.getListOfPlanesOfAppropriateType(PassengerPlane));
